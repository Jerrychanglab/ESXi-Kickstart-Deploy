...
***
# 【 tftpboot-建置 】
### SOP 1. 安裝xinetd與tftp-server
```yum install xinetd tftp-server```
### SOP 2. 配置tftp (創建+貼上內容)
...
### SOP 5. 建置ESXi安裝檔
#### 5.1. 官網下載ESXI ISO (VMware-VMvisor-Installer-8.0U2-22380479.x86_64.iso)
#### 5.2 將ISO檔案丟到虛擬機器內
```
